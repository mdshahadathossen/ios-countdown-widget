...
3. Copy the contents of [`ios-countdown-widget.js`](./https://github.com/mdshahadathossen/ios-countdown-widget/blob/main/ios_countdown_widget.js) and paste it in
